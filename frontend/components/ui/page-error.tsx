...
interface PageErrorProps {
  ...
  reset: () => void;
  /** Optional link to show a contextual "go back" button. Defaults to "/" */
  backHref?: string;
}

export default function PageError({ error, reset, backHref = "/" }: PageErrorProps) {
      ...
      <div className="container relative z-10 mx-auto px-6 max-w-2xl text-center">
        ...
        >
          ...
          <p className="text-white/50 text-base md:text-lg mb-10 font-light leading-relaxed">
            {isRtl
              ? "نعتذر. واجهت الصفحة خطأً غير متوقع وفشلت في التحميل."
