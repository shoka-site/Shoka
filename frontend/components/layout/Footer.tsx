        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="https://x.com/shokaglobal" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">{t('footer.social.twitter')}</a></li>
              ...
              <li><a href="mailto:global@sehel.site" className="text-white/60 hover:text-white transition-colors">global@shoka.site</a></li>
            </ul>
          </div>
        </div>
      </div>
