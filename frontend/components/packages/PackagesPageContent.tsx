...
// Prisma Package includes descriptionEn/descriptionAr not in the Zod schema
...
export function PackagesPageContent({ packages }: Props) {
  ...
  const pickOpt = (enVal: string | null | undefined, arVal: string | null | undefined) =>
              ...
              {packages.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {packages.map((pkg, index) => {
                    ...
                    const description = pickOpt(pkg.descriptionEn, pkg.descriptionAr);
                    return (
                      <motion.div
                        key={pkg.id}
                      ...
                      >
                        ...
                        <div className="flex flex-col flex-1 p-8 md:p-10">
                          ...
                          <h3 className="text-2xl font-display font-black mb-4 group-hover:text-accent transition-colors duration-300">
                            {pick(pkg.titleEn, pkg.titleAr)}
                          </h3>
                          {description ? (
                            <p className="text-muted-foreground leading-relaxed text-base flex-1">{description}</p>
                          ) : (
