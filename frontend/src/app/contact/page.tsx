...
export default function ContactPage() {
  ...
  return (
    <div className="space-y-12">
      <PageHeader
        title="تواصل معنا"
        description="نحن هنا لمساعدتك. سواء كان لديك استفسار أو ترغب في بدء مشروع جديد، يسعدنا سماع صوتك."
      />
          ...
          <div className="glass-panel p-8 rounded-2xl space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 text-slate-300">
                <div className="h-10 w-10 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-400">
                  <Mail size={20} />
                </div>
                <div>
                  <div className="text-xs text-slate-500">البريد الإلكتروني</div>
                  <div>info@ssplatform.com</div>
                </div>
              </div>
              <div className="flex items-center gap-4 text-slate-300">
                <div className="h-10 w-10 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-400">
              ...
              <div className="flex items-center gap-4 text-slate-300">
                ...
                <div>
                  ...
                  <div>بغداد، العراق - شارع الكندي</div>
                </div>
              </div>
            </div>
          </div>
