...
import { updateTestimonialSchema } from '@shared/schema';
...
export const PUT = withErrorHandler(async (
  ...
  if (!updated) return fail('NOT_FOUND', 'Testimonial not found', undefined, 404);
  return ok(updated);
});
...
export const DELETE = withErrorHandler(async (
  ...
  if (!deleted) return fail('NOT_FOUND', 'Testimonial not found', undefined, 404);
